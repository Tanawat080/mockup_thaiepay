...
<section class="content home">
    <div class="container-fluid">
        <div class="block-header">
            <h2>ค่าจัดส่งสินค้าตามอัตราของร้านค้า</h2>
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><i class="material-icons">label</i> ค่าจัดส่งสินค้าตามอัตราของร้านค้า</li>
            </ul>
        </div>
        <div class="row clearfix">
            <div class="col-md-12 col-lg-12">
                <div class="card visitors-map">
                    <div class="header">
                        <h2>วิธีการจัดส่งสินค้าแบบ กำหนดค่าจัดส่งสินค้าเองตามอัตราของร้านค้า</h2>
                    </div>
                    <div class="body">
                        <p class="indent">วิธีการจัดส่งสินค้านี้ คุณสามารถกำหนดค่าจัดส่งได้เองทั้งหมด ซึ่งจะกำหนดค่าจัดส่งเบื้องต้นและ ค่าจัดส่งเมื่อน้ำหนักเพิ่ม ผ่านแบบฟอร์มด้านล่างนี้</p>
