    ...
    <div class="container-fluid">
        <div class="block-header">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><i class="material-icons">label</i> จัดส่งต่างประเทศโดย UPS</li>
            </ul>
        </div>
        <div class="row clearfix">
            <div class="col-md-12 col-lg-12">
                <div class="card visitors-map">
                    <div class="header">
                        <h2>วิธีการจัดส่งสินค้าแบบ ระหว่างประเทศโดย UPS</h2>
                    </div>
                    <div class="body">
                        <p class="indent"> วิธีการจัดส่งสินค้านี้ จะใช้ระบบจัดส่งพัสดุไปรษณีย์ระหว่างประเทศของ UPS ซึ่งจะกำหนดค่าจัดส่งเบื้องต้นและ ค่าจัดส่งเมื่อน้ำหนักเพิ่ม ผ่านแบบฟอร์มด้านล่างนี้ </p>
                        <p class="indent">ระบบการคำนวณค่าจัดส่ง UPS จะต้องใช้ UserID/Password สำหรับการเชื่อมต่อไปขอราคา ผ่านระบบออนไลน์ของ UPS ซึ่งคุณจะต้อง สมัครใช้งานก่อนที่นี่ <a href="http://www.ups.com">http://www.ups.com</a> เมื่อลงทะเบียนและได้ UserID/Password จาก UPS แล้ว ให้กรอกข้อมูลลงในช่องที่ต้องการแล้วคลิกที่ปุ่ม Submit </p>
                    ...
                    <div class="body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="input-group"><span class="input-group-addon"> <i class="material-icons">featured_play_list</i> </span>
                                    <div class="form-line">
                                        <input type="text" class="form-control" value="UPS International Shipping" required/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="input-group"><span class="input-group-addon"> <i class="material-icons">featured_play_list</i> </span>
                                    <div class="form-line">
                                        <input type="text" class="form-control" value="จัดส่งต่างประเทศโดย UPS" required/>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="">
                                    <select class="form-control show-tick" required>
                                        <option selected="selected" value="07">UPS Worldwide Express</option>
                                        <option value="08">UPS Worldwide Expendited</option>
                        ...
                        <div class="row">
                                    <div class="col-sm-12">
                                        <div class="">
                                            <label class="form-label">ค่าจัดส่งโดยปริยาย:* (ค่าจัดส่งโดยปริยาย จะถูกใช่เมื่อระบบไม่สามารถคำนวณค่าจัดส่งผ่านระบบออนไลน์ของ TNT ได้)</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="">
                                            <label class="form-label">UPS Access Number:*</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="">
                                            <label class="form-label">UPS UserID:*</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="">
                                            <label class="form-label">UPS Account:*</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
