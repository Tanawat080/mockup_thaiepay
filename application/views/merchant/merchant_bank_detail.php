    ...
    <div class="container-fluid">
        <div class="block-header">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><i class="material-icons">assignment_ind</i> ข้อมูลส่วนตัวและบัญชีธนาคาร</li>
            </ul>
        </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class="col-blue-grey">ข้อมูลส่วนตัว</h2>
                    </div>
                    <div class="body">
                        <div class="row">                           
                            <div class="col-sm-12"> 
 			...
 			<div class="row clearfix">
	            <div class="col-lg-6 col-md-6 col-sm-12">
	                <div class="card">
	                	<div class="body">
		                   <b class="col-blue-grey">English Information</b><br>
                                    <dl><br>
                                        <dt>THAIEPAY.COM</dt>
                                        <dd>THAIEPAY THAIEPAY</dd>
                                        <dd>522 Ratchadapisek Rd., Samsennok </dd>
                                        <dd>Huaykwang Bangkok 10310 THAILAND</dd>
                                        <dd><br></dd>
                                        <dd>Tel: 02 541 4100 </dd>
                                        <dd>Fax: 02 541 4098</dd>
                                    </dl>
	                    </div>
					</div>
				</div>
	            <div class="col-lg-6 col-md-6 col-sm-12">
	                <div class="card">
	                	<div class="body">
		                   <b class="col-blue-grey">ข้อมูลภาษาไทย</b>

                                    <dl><br>
                                        <dt>THAIEPAY.COM</dt>
                                        <dd>ไทยอีเพย์ ไทยอีเพย์</dd>
                                        <dd>522 ถนน รัชดาภิเษก, สามเสนนอก </dd>
                                        <dd>ห้วยขวาง กรุงเทพฯ 10310 ประเทศไทย</dd>
                                        <dd><br></dd>
                                        <dd>โทร: 02 541 4100 </dd>
                                        <dd>แฟกซ์: 02 541 4098</dd>
                                    </dl>
                 ...
                 <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card">
                        <div class="row">
                            <div class="body col-sm-12">
                           <center>
                                    <img class="img-responsive img-fluid img-thumbnail" src="<?php echo base_url() ?>/assets/images/sign/barcode.gif">
                                </center>
                            </div>
            ...
            <div class="row clearfix">
	            <div class="col-lg-6 col-md-6 col-sm-12">
	                <div class="card">
		                <div class="header">
	                        <h2 class="col-blue-grey">ข้อมูลบัญชีธนาคาร</h2>
	                    </div>
	                	<div class="body">
	                		<div class="row">                           
                            	<div class="col-sm-12"> 
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="card widget-stat  info-box-3 bg-indigo">
                                    <div class="body">
                                        <div class="media">
                                            <div class="media-icon bg-white">
                                                <i class="zmdi zmdi-balance zmdi-hc-2x col-indigo"></i>
                                            </div>
                                            <div class="media-text">
                                                <span class="title col-white">Merchant</span>
                                                <span class="value col-white"> ID : 48509355</span>
                                            </div>
                                        </div> 
                                    </div>
                                </div>
		                    	...
		                    	<table width="100%">
	                            	<tr>
	                            		<td><p>ชื่อบัญชี:	</p></td>
	                            		<td><p>เพย์โซลูชัน</p></td>
	                            	</tr>
	                            	<tr>
	                            		<td><p>เลขที่บัญชี:</p></td>
	                            		<td><p>1234567890</p></td>
	                            	</tr>
	                            	<tr>
	                            		<td><p>สาขา:	 </p></td>
	                            		<td><p>รัชดา(กรุงเทพฯ)</p></td>
	                            	</tr>
	                            	<tr>
	                            		<td><p>ประเภท:	</p></td>
	                            		<td><p>ออมทรัพย์</p></td>
	                            ...
	                            <p><a href="" data-toggle="modal" data-target="#editBankInfo">แก้ไขข้อมูลบัญชีธนาคาร คลิกที่นี่!</a></p>
	                        </div>
					</div>
				</div> <!-- end of banking detail -->

				<div class="col-lg-6 col-md-6 col-sm-12">
	                <div class="card">
	                	<div class="header">
	                		<h2 class="col-blue-grey">โลโก้และหน้าตาเว็บไซต์</h2>
	                	</div>
	                	<div class="body">
		                   	...
		                   	<center>
		                   		<img class="img-responsive img-fluid img-thumbnail" src="<?php echo base_url();?>assets/images/sign/logo.png" wid>
		                   	</center>
                            <div class="form-group">
		                   	  <p><a href="" data-toggle="modal" data-target="#editLogo">แก้ไขข้อมูลบัญชีธนาคาร คลิกที่นี่!</a></p>
                            </div>
	                    </div>
					</div>
				</div><!-- end logo -->
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="largeModalLabel">แก้ไขข้อมูลส่วนตัว</h4>
            </div>
...
<div class="modal fade" id="editBankInfo" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="largeModalLabel">แก้ไขบัญชีธนาคาร</h4>
            </div>
            <div class="modal-body">
            		<form method="post">
	                <div class="row clearfix">
