    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2 class="col-blue-grey">ทิปเทคนิคการใช้งาน</h2>                     
                    </div>
                    <div class="col-sm-12"> 
                        <p class="indent"> เนื่องจากระบบ Control Panel ใหม่ มีหลายส่วนที่ลูกค้าหลายท่านอาจจะยังไม่เข้าใจ หรือไม่ทราบถึงวิธีการใช้งาน เราจึงสรุปทิปเทคนิคง่ายๆ เพื่อแนะนำวิธีการใช้งานให้ลูกค้าทราบดังต่อไปนี้ </p>
                    </div>
                    ...
                    <div class="body">
                        <ol>
                            ...
                            <li>เพื่อเพิ่มสีสันให้กับร้านค้าของคุณ คุณสามารถแก้ไขโลโก้ร้านค้าและหน้าตาเว็บไซต์ให้เป็นไปตามความต้องการของคุณ โดยอาจจะเลือกจากที่ไทยอีเพย์ได้เตรียมไว้ให้ หรือสร้างธีมในแบบของคุณก็ได้ที่เมนู
