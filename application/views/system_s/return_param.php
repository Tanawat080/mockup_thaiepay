            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="row clearfix top-report">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="header">
                                <h2 class="col-blue-grey">ทำความเข้าใจก่อนกำหนดค่า</h2>
                            </div>
                            <div class="body">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="input-group"> <span class="input-group-addon"> <i class="material-icons">language</i> </span>
                                            <div class="form-line">
                                                <input type="text" class="form-control" Value="http://10.127.7.240/wordpress" name="returnUrl" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="input-group"> <span class="input-group-addon"> <i class="material-icons">language</i> </span>
                                            <div class="form-line">
                                                <input type="text" class="form-control" Value="http://10.127.7.240/wordpress/post_back.php" name="postbackUrl" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="input-group"> <span class="input-group-addon"> <i class="material-icons">apps</i> </span>
                                                <div class="form-line">
                                                    <input type="text" name="value" class="form-control" Value="test" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
